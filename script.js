...
/* ========================================
   CUPÓN ESPECIAL — ZAPATILLAS
======================================== */

const botonCuponZapatillas =
    document.querySelector("#botonCuponZapatillas");

const estadoCuponZapatillas =
    document.querySelector("#estadoCuponZapatillas");


async function cargarEstadoCuponZapatillas() {

    if (!botonCuponZapatillas || !estadoCuponZapatillas) {
        return;
    }
    ...
    if (error) {
        ...
        console.error(
            "Error cargando el cupón:",
            error
        );

        estadoCuponZapatillas.textContent =
            "No se pudo comprobar el estado del cupón.";
    ...
    if (data.canjeado) {
        ...
        botonCuponZapatillas.textContent =
            "✅ Cupón canjeado";

        botonCuponZapatillas.classList.add(
            "canjeado"
        );

        botonCuponZapatillas.disabled = true;

        estadoCuponZapatillas.textContent =
            "Este cupón ya fue utilizado. 👟❤️";
    }
}


if (botonCuponZapatillas) {

    botonCuponZapatillas.addEventListener(
        "click",
        async function() {
            ...
            if (error) {
                ...
                console.error(
                    "Error canjeando el cupón:",
                    error
                );

                botonCuponZapatillas.disabled =
                    false;
                ...
                estadoCuponZapatillas.textContent =
                    "Hubo un problema. Probá nuevamente.";
            ...
            estadoCuponZapatillas.textContent =
                "Ahora vamos a elegir tus zapatillas. Cuchu te las regala. ❤️👟";
